        ...
        <div style={{ maxWidth: "1440px", margin: "0 auto", padding: "0 2.5rem" }}>
          <div className="about-story-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "6rem", alignItems: "center" }}>
            ...
            <motion.div initial={{ opacity: 0, y: 28 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 1 }}>
              ...
              <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.88rem", lineHeight: 2, color: MUTED, fontWeight: 300, marginBottom: "1.25rem" }}>
                {a.storyP1}
              </p>
              <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.88rem", lineHeight: 2, color: MUTED, fontWeight: 300, marginBottom: "2.5rem" }}>
                {a.storyP2}
              </p>
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 1, delay: 0.15 }}
              ...
              <div style={{ overflow: "hidden" }}>
                <img src={STORY_IMGS[0]} alt="Villa Romantica" style={{ width: "100%", height: "340px", objectFit: "cover", display: "block", transition: "transform 0.8s ease" }}
                  onMouseEnter={(e) => { e.currentTarget.style.transform = "scale(1.04)"; }}
                  onMouseLeave={(e) => { e.currentTarget.style.transform = "scale(1)"; }} />
              </div>
              <div style={{ overflow: "hidden", marginTop: "2.5rem" }}>
                <img src={STORY_IMGS[1]} alt="Aegean sea" style={{ width: "100%", height: "340px", objectFit: "cover", display: "block", transition: "transform 0.8s ease" }}
                  onMouseEnter={(e) => { e.currentTarget.style.transform = "scale(1.04)"; }}
                  onMouseLeave={(e) => { e.currentTarget.style.transform = "scale(1)"; }} />
              </div>
            </motion.div>
        ...
        <div style={{ maxWidth: "1440px", margin: "0 auto", padding: "0 2.5rem" }}>
          ...
          <div className="values-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "0" }}>
            {a.values.map((v, i) => (
              ...
              >
                <p style={{ fontFamily: "'Cinzel', serif", fontSize: "0.5rem", letterSpacing: "0.3em", textTransform: "uppercase", color: "rgba(68,67,64,0.35)", marginBottom: "1.25rem" }}>
                  0{i + 1}
                </p>
                <h3 style={{ fontFamily: "'Cinzel', serif", fontSize: "clamp(1.1rem, 2vw, 1.6rem)", fontWeight: 400, color: C, letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: "1.25rem" }}>
                  {v.title}
                </h3>
                <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.88rem", lineHeight: 2, color: MUTED, fontWeight: 300 }}>
                  {v.desc}
                </p>
              </motion.div>
            ))}
        ...
        <div style={{ maxWidth: "1440px", margin: "0 auto", padding: "0 2.5rem" }}>
          <div className="about-place-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "6rem", alignItems: "center" }}>
            ...
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 1 }}
              ...
              <img src={PLACE_IMG} alt="Palio, Kavala" style={{ width: "100%", height: "520px", objectFit: "cover", display: "block", transition: "transform 0.9s ease" }}
