...
const HERO_IMG        = "/photos/experience/experience-2.jpg";
  ...
  return (
    <main>
      ...
      <section style={{ position: "relative", height: "90vh", minHeight: "580px", overflow: "hidden" }}>
        <img
          src={HERO_IMG}
          alt="Food & Drinks at Villa Romantica"
        ...
        <div style={{ position: "relative", height: "100%", display: "flex", flexDirection: "column", justifyContent: "flex-end", padding: "0 2.5rem clamp(3.5rem, 7vw, 6rem)", maxWidth: "100%", margin: "0 auto" }}>
          <motion.div initial={{ opacity: 0, y: 28 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1.1 }}>
            ...
            <h1 style={{ fontFamily: "'Cinzel', serif", fontSize: "clamp(3rem, 8vw, 7rem)", fontWeight: 400, color: "#ffffff", lineHeight: 1, letterSpacing: "0.06em", textTransform: "uppercase", margin: 0 }}>
              {d.heroHeading[0]}<br />{d.heroHeading[1]}
            </h1>
          </motion.div>
        </div>
      </section>
      ...
      {/* ── Photo Strip ── */}
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "0" }} className="photo-strip">
      ...
      <section style={{ backgroundColor: "#ffffff", padding: "9rem 0" }}>
        <div style={{ maxWidth: "100%", margin: "0 auto", padding: "0 2.5rem" }}>
          <div className="dining-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "6rem", alignItems: "center" }}>
            ...
            {/* Images */}
            <motion.div initial={{ opacity: 0, x: -24 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 1 }}
              style={{ display: "grid", gridTemplateRows: "auto auto", gap: "0.5rem" }}>
              <div style={{ overflow: "hidden" }}>
