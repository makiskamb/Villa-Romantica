...
export function Experience() {
  ...
  const barHeroImg   = useParallax(0.16);
  const barImg2      = useParallax(0.12);
  const localImg1    = useParallax(0.11);
  const localImg2    = useParallax(0.13);
  const stripRef     = useParallaxContainer();
    ...
    <main>
      ...
      <section style={{ backgroundColor: "#ffffff", padding: "7rem 0" }}>
        <div style={{ maxWidth: "100%", margin: "0 auto", padding: "0 2.5rem" }}>
          <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 1 }} style={{ maxWidth: "680px" }}>
      ...
      {/* ── Photo Strip ── */}
      <div ref={stripRef} style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)" }} className="photo-strip">
        {STRIP_IMGS.map((src, i) => (
          <div key={i} style={{ overflow: "hidden" }}>
            <img
              ...
              alt=""
              data-parallax
              data-speed={[0.10, 0.14, 0.09, 0.12][i]}
              style={{ width: "100%", height: "312px", objectFit: "cover", display: "block", willChange: "transform" }}
            />
          </div>
        ))}
      </div>
          ...
          <div className="dining-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1.1fr", gap: "6rem", alignItems: "start" }}>
            ...
            <motion.div initial={{ opacity: 0, x: 24 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 1, delay: 0.1 }}>
              <div style={{ overflow: "hidden" }}>
                <img ref={barImg2} src={BAR_IMG_2} alt="Bar drinks"
        ...
        <div style={{ maxWidth: "100%", margin: "0 auto", padding: "0 2.5rem" }}>
          <div className="dining-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "6rem", alignItems: "center" }}>
            ...
            <motion.div initial={{ opacity: 0, x: -24 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 1 }}
              ...
              <div style={{ overflow: "hidden" }}>
                <img ref={localImg2} src={LOCAL_IMG_2} alt="Palio village"
                  style={{ width: "100%", height: "288px", objectFit: "cover", display: "block", willChange: "transform" }} />
              </div>
            </motion.div>
            ...
            <motion.div initial={{ opacity: 0, y: 28 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 1, delay: 0.12 }}>
              ...
              <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.9rem", lineHeight: 2.1, color: MUTED, fontWeight: 300 }}>{d.localP2}</p>
